...
public interface UsuarioRepositorio extends JpaRepository<Usuario, Integer> {
    ...
    /**/
    @Query(nativeQuery = true, value = "select disciplina_Id from (Competidores_Eventos natural join Evento)")
    List<Integer> cuentaEventosEntrenador(@Param("id")Integer id);
    /*
